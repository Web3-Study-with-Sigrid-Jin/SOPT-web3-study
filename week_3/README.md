...
예를 들어, 카카오 클레이튼의 Klay 코인을 이더리움 네트워크 위의 탈중앙화 거래소에서 거래하기 위해서는 이더리움 네트워크 상에 ERC20에 클레이튼 '토큰' 을 활용해야 합니다.

Uniswap, 오르빗 브리지가 탈중앙화 거래소의 예시입니다. 이더리움 네트워크에서 구매한 Klay 토큰을 카카오 클레이튼 네트워크의 Klay 코인으로 바꾸기 위해서는 Bridge의 예시 중 하나인 오르빗 브리지를 사용해야 합니다.
